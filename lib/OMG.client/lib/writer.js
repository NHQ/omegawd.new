...
//				$('body').append('<script src="/lib/ace.build/build/src/ace-noconflict.js" type="text/javascript" charset="utf-8"></script>')

//				$('body').append('<script src="/lib/ace.build/build/src/theme-textmate-noconflict.js" type="text/javascript" charset="utf-8"><///script>')

//				$('body').append('<script src="/lib/ace.build/build/src/mode-javascript-noconflict.js" type="text/javascript" charset="utf-8"></script>')

//				$('body').load('/html/writer.html', tempLoaded) // loadng html template
