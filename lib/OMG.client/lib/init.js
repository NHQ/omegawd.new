...
module.exports = function(){	
	...
	this.eve.on('readyFS', this.frontis) // <-- endpoint. **NOTICE**! If we had actual files and sets, we would index the metadb file and init the whole app. Currently: creates new writer
