...
,		bundle = require('browserify')({watch: true})
			...
			.use(bjade(__dirname + '/OMG.client/html/templates'))
...
function clientDeps(cb){
	...
	var platform = fs.readFileSync('./platform.js/platform.js', 'utf8')
	...
	,		js_libs = jQ + $_ + transform + bean + store + webFS + Ev + paper + stylus + platform
	,		parser = require('./parser/parser.js')(jQ.toString())
	,		initServer = function(){
